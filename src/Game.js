		...
		that.btnMouseOver = function(button){
			if(button.getAttribute('enable') === "true"){
				if(button.id == "start_btn")
					button.src = define.frameworkPath + "image/play_over.png";
				if(button.id == "pause_btn")
					button.src = define.frameworkPath + "image/pause_over.png";
				if(button.id == "stop_btn")
					button.src = define.frameworkPath + "image/stop_over.png";
				if(button.id == "type_btn")
					button.src = define.frameworkPath + "image/addComment_over.png";
				if(button.id == "replay_btn")
					button.src = define.frameworkPath + "image/replay_over.png";
				if(button.id == "variable_btn")
					button.src = define.frameworkPath + "image/variable_over.png";
			}
		};
		that.btnMouseOut = function(button){
			if(button.getAttribute('enable') === "true"){
				if(button.id == "start_btn")
					button.src = define.frameworkPath + "image/play.png";
				if(button.id == "pause_btn")
					button.src = define.frameworkPath + "image/pause.png";
				if(button.id == "stop_btn")
					button.src = define.frameworkPath + "image/stop.png";
				if(button.id == "type_btn")
					button.src = define.frameworkPath + "image/addComment.png";
				if(button.id == "replay_btn")
					button.src = define.frameworkPath + "image/replay.png";
				if(button.id == "variable_btn")
					button.src = define.frameworkPath + "image/variable.png";
			}
		};
		that.btnEnable = function(){
			if(document.getElementById("start_btn").getAttribute("enable") === "true")
				document.getElementById("start_btn").src = define.frameworkPath + "image/play.png";
			else
				document.getElementById("start_btn").src = define.frameworkPath + "image/play_disable.png";
			
			if(document.getElementById("pause_btn").getAttribute("enable") === "true")
				document.getElementById("pause_btn").src = define.frameworkPath + "image/pause.png";
			else
				document.getElementById("pause_btn").src = define.frameworkPath + "image/pause_disable.png";
			
			if(document.getElementById("stop_btn").getAttribute("enable") === "true")
				document.getElementById("stop_btn").src = define.frameworkPath + "image/stop.png";
			else
				document.getElementById("stop_btn").src = define.frameworkPath + "image/stop_disable.png";
			
			if(document.getElementById("type_btn").getAttribute("enable") === "true")
				document.getElementById("type_btn").src = define.frameworkPath + "image/addComment.png";
			else
				document.getElementById("type_btn").src = define.frameworkPath + "image/addComment_disable.png";
			
			if(document.getElementById("replay_btn").getAttribute("enable") === "true")
				document.getElementById("replay_btn").src = define.frameworkPath + "image/replay.png";
			else
				document.getElementById("replay_btn").src = define.frameworkPath + "image/replay_disable.png";
			
			if(document.getElementById("variable_btn").getAttribute("enable") === "true")
				document.getElementById("variable_btn").src = define.frameworkPath + "image/variable.png";
			else
				document.getElementById("variable_btn").src = define.frameworkPath + "image/variable_disable.png";
		};
		//Event Handler
		// mouse event
...
listMember = function(main, space, divId) {
	if(document.getElementById(divId+"_check")){
		if(document.getElementById(divId+"_check").src.match(define.frameworkPath + "image/arrow_over.png")){
			document.getElementById(divId+"_check").src = define.frameworkPath + "image/arrow.png";
		}else{
			document.getElementById(divId+"_check").src = define.frameworkPath + "image/arrow_over.png";
		}
	}
			...
			try{
				if(eval(main)[key].toString().indexOf("function", 0) === -1){
					if(key != "rootScene" && key != "autoDelete" && key != "_firstDraw" && key != "_allGameElement"){
						...
						checkBox.setAttribute("src",define.frameworkPath + "image/arrow.png");
