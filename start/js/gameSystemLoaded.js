...
var defProp=()=>
{
    ...
    GR.PropDictionary=
    {
        ...
        "女僕咖啡廳的紅藥水":new Prop("女僕咖啡廳的紅藥水",1,function(pokemon){var propList=GameSystem.HTMLObjectContainer.propList;pokemon.HP+=10;if(pokemon.HP>pokemon.maxHP)pokemon.HP=pokemon.maxHP;propList.update();},x,function(){new GameSystem.Classes.PokemonsSelectDialog(this);},200)
    };
}
/** 定義所有的劇本 */
var defPlot=()=>{
