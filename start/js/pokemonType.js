...
class PokemonType extends GameSystem.Classes.StandardStat {
     ...
     * @param {number} catchRate 此種寶可夢的捕獲率。
     */
    constructor(basicStat, id, image, backImage, name, usableMoves, typeA, typeB, description, basicExp, expType, catchRate) {
    ...
    get catchRate() { return this._catchRate; }
...
(() => {
    ...
    DEX["妙蛙種子"] = new PokemonType(basicStat, 1, new Image(pokemonImagePath + "001_妙蛙種子.png"), new Image(pokemonImagePath + "001_妙蛙種子_Back.png"), "妙蛙種子", moves, Type.Grass, Type.Poison, "它可以在不吃不喝的情況下生存數天。它背上的球可以儲存能量。", 64, ExpType.Slow, 45);
    ...
    DEX["妙蛙草"] = new PokemonType(basicStat, 2, new Image(pokemonImagePath + "002_妙蛙草.png"), new Image(pokemonImagePath + "002_妙蛙草_Back.png"), "妙蛙草", moves, Type.Grass, Type.Poison, "當吸取養分而長大的花苞發出香味的時候，就是表示花即將盛開的訊息。", 141, ExpType.Slow, 45);
    ...
    DEX["妙蛙花"] = new PokemonType(basicStat, 3, new Image(pokemonImagePath + "003_妙蛙花.png"), new Image(pokemonImagePath + "003_妙蛙花_Back.png"), "妙蛙花", moves, Type.Grass, Type.Poison, "開在背上的大花，會吸取太陽的光芒，並轉換成體內的能源。", 208, ExpType.Slow, 45);
    ...
    DEX["小火龍"] = new PokemonType(basicStat, 4, new Image(pokemonImagePath + "004_小火龍.png"), new Image(pokemonImagePath + "004_小火龍_Back.png"), "小火龍", moves, Type.Fire, Type.Normal, "如果把牠帶到安靜的地方去，就可以聽到牠尾巴的火焰燃燒時發出的小聲音。", 65, ExpType.Slow, 45);
    ...
    DEX["火恐龍"] = new PokemonType(basicStat, 5, new Image(pokemonImagePath + "005_火恐龍.png"), new Image(pokemonImagePath + "005_火恐龍_Back.png"), "火恐龍", moves, Type.Fire, undefined, "和強敵持續進行戰鬥，使牠感到興奮的時候，據說會噴出青白色的火焰。", 142, ExpType.Slow, 45);
    ...
    DEX["噴火龍"] = new PokemonType(basicStat, 6, new Image(pokemonImagePath + "006_噴火龍.png"), new Image(pokemonImagePath + "006_噴火龍_Back.png"), "噴火龍", moves, Type.Fire, Type.Flying, "從口中吐出劇烈火焰時，尾巴尾端燃燒的火焰會比平常時燃燒的更猛烈。", 209, ExpType.Slow, 45);
    ...
    DEX["傑尼龜"] = new PokemonType(basicStat, 7, new Image(pokemonImagePath + "007_傑尼龜.png"), new Image(pokemonImagePath + "007_傑尼龜_Back.png"), "傑尼龜", moves, Type.Water, undefined, "會從水面上噴水來獵取食物。遇到危險時，會將手腳縮進甲殼裡來保護自己。", 66, ExpType.Slow, 45);
    ...
    DEX["卡咪龜"] = new PokemonType(basicStat, 8, new Image(pokemonImagePath + "008_卡咪龜.png"), new Image(pokemonImagePath + "008_卡咪龜_Back.png"), "卡咪龜", moves, Type.Water, undefined, "如果突然拍它頭的話，它就會躲進甲殼裡。不過，尾巴會暫時留在外面喔。", 143, ExpType.Slow, 45);
    ...
    DEX["水箭龜"] = new PokemonType(basicStat, 9, new Image(pokemonImagePath + "009_水箭龜.png"), new Image(pokemonImagePath + "009_水箭龜_Back.png"), "水箭龜", moves, Type.Water, undefined, "一旦瞄準敵人攻擊，會向對方噴出比消防車的水槍更強力的水柱來攻擊對方。", 210, ExpType.Slow, 45);
    ...
    DEX["綠毛蟲"] = new PokemonType(basicStat, 10, new Image(pokemonImagePath + "010_綠毛蟲.png"), new Image(pokemonImagePath + "010_綠毛蟲_Back.png"), "綠毛蟲", moves, Type.Bug, undefined, "如果碰觸它頭頂上的觸角，就會分泌出一種強烈的味道去驅退敵人，藉此保護自己。", 53, ExpType.Fast, 255);
    ...
    DEX["鐵甲蛹"] = new PokemonType(basicStat, 11, new Image(pokemonImagePath + "011_鐵甲蛹.png"), new Image(pokemonImagePath + "011_鐵甲蛹_Back.png"), "鐵甲蛹", moves, Type.Bug, undefined, "即使為了保護身體一味地讓殼變硬，但受到強烈的撞擊，裡面的身體還是會掉出來。", 72, ExpType.Fast, 120);
    ...
    DEX["巴大蝶"] = new PokemonType(basicStat, 12, new Image(pokemonImagePath + "012_巴大蝶.png"), new Image(pokemonImagePath + "012_巴大蝶_Back.png"), "巴大蝶", moves, Type.Bug, Type.Flying, "翅膀上具有猛毒磷粉，可以將水滴彈開，所以下雨天也可以飛行。", 160, ExpType.Fast, 45);
    ...
    DEX["獨角蟲"] = new PokemonType(basicStat, 13, new Image(pokemonImagePath + "013_獨角蟲.png"), new Image(pokemonImagePath + "013_獨角蟲_Back.png"), "獨角蟲", moves, Type.Bug, Type.Poison, "頭上有尖銳的針，躲藏在森林裡草木茂盛的地方，專心地吃著葉子。", 52, ExpType.Fast, 255);

    basicStat = {maxHP: 45, attack: 25, defense: 50, special: 25, speed: 35};
    moves = [new GradingMove(undefined, MoveDEX["變硬"])];
    DEX["鐵殼蛹"] = new PokemonType(basicStat, 14, new Image(pokemonImagePath + "014_鐵殼蛹.png"), new Image(pokemonImagePath + "014_鐵殼蛹_Back.png"), "鐵殼蛹", moves, Type.Bug, Type.Poison, "本身無法移動，遇到危險的時候，有時也會射出針或毒液來保護自己。", 71, ExpType.Fast, 120);
    ...
    DEX["比比鳥"] = new PokemonType(basicStat, 17, new Image(pokemonImagePath + "017_比比鳥.png"), new Image(pokemonImagePath + "017_比比鳥_Back.png"), "比比鳥", moves, Type.Normal, Type.Flying, "因為牠的體力很充足，所以飛行的範圍非常廣泛，會飛到很遠的地方去尋找食物。", 113, ExpType.Slow, 120);
    ...
    DEX["拉達"] = new PokemonType(basicStat, 20, new Image(pokemonImagePath + "020_拉達.png"), new Image(pokemonImagePath + "020_拉達_Back.png"), "拉達", moves, Type.Normal, undefined, "後腳上面附著小小的蹼，能在河流中游泳，這是為了要從水中抓取食物。", 116, ExpType.Fast, 127);
    ...
    DEX["烈雀"] = new PokemonType(basicStat, 21, new Image(pokemonImagePath + "021_烈雀.png"), new Image(pokemonImagePath + "021_烈雀_Back.png"), "烈雀", moves, Type.Normal, Type.Flying, "不能飛得很高，為了保護自己的地盤，總是以很快的速度來回地飛來飛去。", 58, ExpType.Fast, 255);
    ...
    DEX["大嘴雀"] = new PokemonType(basicStat, 22, new Image(pokemonImagePath + "022_大嘴雀.png"), new Image(pokemonImagePath + "022_大嘴雀_Back.png"), "大嘴雀", moves, Type.Normal, Type.Flying, "從很久以前就存在的寶可夢，只要一感覺到有不對勁，就會馬上飛到高空躲避。", 162, ExpType.Fast, 90);
    ...
    DEX["阿柏蛇"] = new PokemonType(basicStat, 23, new Image(pokemonImagePath + "023_阿柏蛇.png"), new Image(pokemonImagePath + "023_阿柏蛇_Back.png"), "阿柏蛇", moves, Type.Poison, undefined, "身體在成長過程中會越變越長。在夜裡，牠會把身體一圈圈纏繞在樹枝上睡覺。", 62, ExpType.Fast, 255);
    ...
    DEX["尼多娜"] = new PokemonType(basicStat, 30, new Image(pokemonImagePath + "030_尼多娜.png"), new Image(pokemonImagePath + "030_尼多娜_Back.png"), "尼多娜", moves, Type.Poison, undefined, "在巢穴深處的時候，身上的刺會隱藏起來，呈現放鬆的狀態。", 117, ExpType.Slow, 120);
    ...
    DEX["尼多力諾"] = new PokemonType(basicStat, 33, new Image(pokemonImagePath + "033_尼多力諾.png"), new Image(pokemonImagePath + "033_尼多力諾_Back.png"), "尼多力諾", moves, Type.Poison, undefined, "牠頭上尖角的構造是一旦撞擊刺穿東西就會自動流出毒液。", 118, ExpType.Slow, 120);
    ...
    DEX["尼多王"] = new PokemonType(basicStat, 34, new Image(pokemonImagePath + "034_尼多王.png"), new Image(pokemonImagePath + "034_尼多王_Back.png"), "尼多王", moves, Type.Poison, Type.Ground, "活用像鋼一樣堅韌的皮膚可以將撞擊的威力增強，角可以將鑽石刺破。", 195, ExpType.Slow, 45);
    ...
    DEX["皮皮"] = new PokemonType(basicStat, 35, new Image(pokemonImagePath + "035_皮皮.png"), new Image(pokemonImagePath + "035_皮皮_Back.png"), "皮皮", moves, Type.Normal, undefined, "它的造型和動作都非常的可愛，所以非常受人歡迎。不過因為數量很少，所以不容易發現。", 68, ExpType.Faster, 150);
    ...
    DEX["皮可西"] = new PokemonType(basicStat, 36, new Image(pokemonImagePath + "036_皮可西.png"), new Image(pokemonImagePath + "036_皮可西_Back.png"), "皮可西", moves, Type.Normal, undefined, "非常重視屬於自己族群的世界，不容易在人類面其出現，是妖精們的夥伴。", 129, ExpType.Faster, 25);
    ...
    DEX["六尾"] = new PokemonType(basicStat, 37, new Image(pokemonImagePath + "037_六尾.png"), new Image(pokemonImagePath + "037_六尾_Back.png"), "六尾", moves, Type.Fire, Type.Ice, "柔順整齊的尾巴非常美麗，隨著牠長大，尾巴的末端會分開，數目也會跟著增加。", 63, ExpType.Fast, 190);
    ...
    DEX["九尾"] = new PokemonType(basicStat, 38, new Image(pokemonImagePath + "038_九尾.png"), new Image(pokemonImagePath + "038_九尾_Back.png"), "九尾", moves, Type.Fire, Type.Ice, "自古流傳一個有趣的傳說，據說它是由九位聖者融合而誕生的。", 178, ExpType.Fast, 75);
    ...
    DEX["胖丁"] = new PokemonType(basicStat, 39, new Image(pokemonImagePath + "039_胖丁.png"), new Image(pokemonImagePath + "039_胖丁_Back.png"), "胖丁", moves, Type.Normal, undefined, "當牠轉動可愛的大眼睛，並看著對方時，會唱出不可思議、令人覺得非常舒服的歌曲，讓對手睡著。", 76, ExpType.Faster, 170);
    ...
    DEX["胖可丁"] = new PokemonType(basicStat, 40, new Image(pokemonImagePath + "040_胖可丁.png"), new Image(pokemonImagePath + "040_胖可丁_Back.png"), "胖可丁", moves, Type.Normal, undefined, "擁有體力非常優越的身體，當牠深深吸氣的時候，身體就會膨脹的很大。", 109, ExpType.Faster, 50);
    ...
    DEX["超音蝠"] = new PokemonType(basicStat, 41, new Image(pokemonImagePath + "041_超音蝠.png"), new Image(pokemonImagePath + "041_超音蝠_Back.png"), "超音蝠", moves, Type.Poison, Type.Flying, "一邊從嘴裡發射超音波以調查前面都有什麼，一邊飛行。", 54, ExpType.Fast, 255);
    ...
    DEX["大嘴蝠"] = new PokemonType(basicStat, 42, new Image(pokemonImagePath + "042_大嘴蝠.png"), new Image(pokemonImagePath + "042_大嘴蝠_Back.png"), "大嘴蝠", moves, Type.Poison, Type.Flying, "會從不知哪裡悄悄接近。用尖銳的牙咬住獵物的同時拚命地吸血。", 171, ExpType.Fast, 90);
    ...
    DEX["走路草"] = new PokemonType(basicStat, 43, new Image(pokemonImagePath + "043_走路草.png"), new Image(pokemonImagePath + "043_走路草_Back.png"), "走路草", moves, Type.Grass, Type.Poison, "以為牠是普通的雜草而將牠拔起來，牠會發出叫聲，不知為何這讓人覺得很恐怖。", 78, ExpType.Slow, 255);
    ...
    DEX["臭臭花"] = new PokemonType(basicStat, 44, new Image(pokemonImagePath + "044_臭臭花.png"), new Image(pokemonImagePath + "044_臭臭花_Back.png"), "臭臭花", moves, Type.Grass, Type.Poison, "味道奇臭無比！然而大約每１０００人之中還是會有１個人喜歡聞這味道。", 132, ExpType.Slow, 120);
    ...
    DEX["霸王花"] = new PokemonType(basicStat, 45, new Image(pokemonImagePath + "045_霸王花.png"), new Image(pokemonImagePath + "045_霸王花_Back.png"), "霸王花", moves, Type.Grass, Type.Poison, "為了散布有毒的花粉而搖晃巨大的花瓣，迴蕩著巨大的聲響。", 184, ExpType.Slow, 45);
    ...
    DEX["派拉斯"] = new PokemonType(basicStat, 46, new Image(pokemonImagePath + "046_派拉斯.png"), new Image(pokemonImagePath + "046_派拉斯_Back.png"), "派拉斯", moves, Type.Bug, Type.Grass, "會挖洞從樹根處獲取營養，不過其中的絕大部分都會被背上的蘑菇奪走。", 70, ExpType.Fast, 190);
    ...
    DEX["派拉斯特"] = new PokemonType(basicStat, 47, new Image(pokemonImagePath + "047_派拉斯特.png"), new Image(pokemonImagePath + "047_派拉斯特_Back.png"), "派拉斯特", moves, Type.Bug, Type.Grass, "一直被不斷吸取精華，已經不是蟲而是背上的蘑菇在思考。", 128, ExpType.Fast, 75);
    ...
    DEX["毛球"] = new PokemonType(basicStat, 48, new Image(pokemonImagePath + "048_毛球.png"), new Image(pokemonImagePath + "048_毛球_Back.png"), "毛球", moves, Type.Bug, Type.Poison, "大眼睛有著雷達的功能，在明亮的地方可以看到小眼睛聚集的景象。", 75, ExpType.Fast, 190);
    ...
    DEX["三地鼠"] = new PokemonType(basicStat, 51, new Image(pokemonImagePath + "051_三地鼠.png"), new Image(pokemonImagePath + "051_三地鼠_Back.png"), "三地鼠", moves, Type.Ground, undefined, "報告稱三隻一組的力量可以向地下挖100公里，因此變成地震的原因。", 153, ExpType.Fast, 50);
    ...
    DEX["喵喵"] = new PokemonType(basicStat, 52, new Image(pokemonImagePath + "052_喵喵.png"), new Image(pokemonImagePath + "052_喵喵_Back.png"), "喵喵", moves, Type.Normal, undefined, "到了晚上會更有精力。喜歡圓圓的發亮的東西，找到的話就非撿走不可。", 69, ExpType.Fast, 255);
    ...
    DEX["貓老大"] = new PokemonType(basicStat, 53, new Image(pokemonImagePath + "053_貓老大.png"), new Image(pokemonImagePath + "053_貓老大_Back.png"), "貓老大", moves, Type.Normal, undefined, "額頭上的寶石閃閃發光！而且走路的姿態非常優美，像公主一樣引人注目。", 148, ExpType.Fast, 90);
    ...
    DEX["可達鴨"] = new PokemonType(basicStat, 54, new Image(pokemonImagePath + "054_可達鴨.png"), new Image(pokemonImagePath + "054_可達鴨_Back.png"), "可達鴨", moves, Type.Water, undefined, "一直被頭痛困擾著。會在自己意識不到的情況下使用念力。", 80, ExpType.Fast, 190);
    ...
    DEX["哥達鴨"] = new PokemonType(basicStat, 55, new Image(pokemonImagePath + "055_哥達鴨.png"), new Image(pokemonImagePath + "055_哥達鴨_Back.png"), "哥達鴨", moves, Type.Water, undefined, "用細長的四肢和發達的大腳蹼在湖裡優雅地遊動。", 174, ExpType.Fast, 75);
    ...
    DEX["猴怪"] = new PokemonType(basicStat, 56, new Image(pokemonImagePath + "056_猴怪.png"), new Image(pokemonImagePath + "056_猴怪_Back.png"), "猴怪", moves, Type.Fighting, undefined, "身體輕巧，在樹上生活。會不明原因地心情不好，向周圍的東西猛撲過去。", 74, ExpType.Fast, 190);
    ...
    DEX["火爆猴"] = new PokemonType(basicStat, 57, new Image(pokemonImagePath + "057_火爆猴.png"), new Image(pokemonImagePath + "057_火爆猴_Back.png"), "火爆猴", moves, Type.Fighting, undefined, "只有周圍誰都不在時，牠才會停止發火。但要見到這個情景是很難的。", 149, ExpType.Fast, 75);
    ...
    DEX["卡蒂狗"] = new PokemonType(basicStat, 58, new Image(pokemonImagePath + "058_卡蒂狗.png"), new Image(pokemonImagePath + "058_卡蒂狗_Back.png"), "卡蒂狗", moves, Type.Fire, undefined, "雖然性格很親近人，但是會對進入自己領地的敵人狂吠。", 91, ExpType.Slower, 190);
    ...
    DEX["風速狗"] = new PokemonType(basicStat, 59, new Image(pokemonImagePath + "059_風速狗.png"), new Image(pokemonImagePath + "059_風速狗_Back.png"), "風速狗", moves, Type.Fire, undefined, "中國傳說中寶可夢。無數人被其輕巧跑動的身姿所擄獲。", 213, ExpType.Slower, 75);
    ...
    DEX["蚊香蝌蚪"] = new PokemonType(basicStat, 60, new Image(pokemonImagePath + "060_蚊香蝌蚪.png"), new Image(pokemonImagePath + "060_蚊香蝌蚪_Back.png"), "蚊香蝌蚪", moves, Type.Water, undefined, "漩渦的方向好像會隨出生的地區而不同。比起走路更擅長游泳。", 77, ExpType.Slow, 255);
    ...
    DEX["蚊香君"] = new PokemonType(basicStat, 61, new Image(pokemonImagePath + "061_蚊香君.png"), new Image(pokemonImagePath + "061_蚊香君_Back.png"), "蚊香君", moves, Type.Water, Type.Normal, "似乎感到要被襲擊的時候就使用腹部的漩渦讓對手睡著，趁機逃走。", 131, ExpType.Slow, 120);
    ...
    DEX["蚊香泳士"] = new PokemonType(basicStat, 62, new Image(pokemonImagePath + "062_蚊香泳士.png"), new Image(pokemonImagePath + "062_蚊香泳士_Back.png"), "蚊香泳士", moves, Type.Water, Type.Fighting, "用全身肌肉有力地游泳，奧林匹克選手也要甘拜下風。", 185, ExpType.Slow, 45);

    basicStat = {maxHP: 25, attack: 20, defense: 15, special: 105, speed: 90};
    moves = [new GradingMove(undefined, MoveDEX["瞬間移動"])];
    DEX["凱西"] = new PokemonType(basicStat, 63, new Image(pokemonImagePath + "063_凱西.png"), new Image(pokemonImagePath + "063_凱西_Back.png"), "凱西", moves, Type.Phycsic, undefined, "一天睡18個小時。危險逼近的時候就算還在睡著也會使用瞬移逃跑。", 75, ExpType.Slow, 200);
    ...
    DEX["勇基拉"] = new PokemonType(basicStat, 64, new Image(pokemonImagePath + "064_勇基拉.png"), new Image(pokemonImagePath + "064_勇基拉_Back.png"), "勇基拉", moves, Type.Phycsic, undefined, "勇基拉的身邊會發生像是鐘錶指針倒轉之類奇怪的事情。", 145, ExpType.Slow, 100);

    basicStat = {maxHP: 55, attack: 50, defense: 45, special: 135, speed: 120};
    moves = [new GradingMove(undefined, MoveDEX["瞬間移動"]), new GradingMove(undefined, MoveDEX["折彎湯匙"]), new GradingMove(16, MoveDEX["念力"]), new GradingMove(20, MoveDEX["定身法"]), new GradingMove(27, MoveDEX["幻象光線"]), new GradingMove(31, MoveDEX["自我再生"]), new GradingMove(38, MoveDEX["精神強念"]), new GradingMove(42, MoveDEX["反射壁"])];
    DEX["胡地"] = new PokemonType(basicStat, 65, new Image(pokemonImagePath + "065_胡地.png"), new Image(pokemonImagePath + "065_胡地_Back.png"), "胡地", moves, Type.Phycsic, undefined, "什麼事情都可以記住。體驗過的過去的事情絕不會忘，頭腦非常好。", 186, ExpType.Slow, 50);
    ...
    DEX["腕力"] = new PokemonType(basicStat, 66, new Image(pokemonImagePath + "066_腕力.png"), new Image(pokemonImagePath + "066_腕力_Back.png"), "腕力", moves, Type.Fighting, undefined, "雖然身體很小卻很有力量。而且精通多種格鬥技，非常強。", 75, ExpType.Slow, 180);
    ...
    DEX["豪力"] = new PokemonType(basicStat, 67, new Image(pokemonImagePath + "067_豪力.png"), new Image(pokemonImagePath + "067_豪力_Back.png"), "豪力", moves, Type.Fighting, undefined, "腰上繫着的限制力量的腰帶，解開腰帶的豪力的氣勢無人能當。", 146, ExpType.Slow, 90);

    basicStat = {maxHP: 90, attack: 130, defense: 80, special: 65, speed: 55};
    moves = [new GradingMove(undefined, MoveDEX["空手劈"]), new GradingMove(undefined, MoveDEX["踢倒"]), new GradingMove(undefined, MoveDEX["瞪眼"]), new GradingMove(20, MoveDEX["踢倒"]), new GradingMove(25, MoveDEX["瞪眼"]), new GradingMove(36, MoveDEX["聚氣"]), new GradingMove(44, MoveDEX["地球上投"]), new GradingMove(52, MoveDEX["地獄翻滾"])];
    DEX["怪力"] = new PokemonType(basicStat, 68, new Image(pokemonImagePath + "068_怪力.png"), new Image(pokemonImagePath + "068_怪力_Back.png"), "怪力", moves, Type.Fighting, undefined, "擁有用一隻手也可以使山移動的力量，用4隻手一起打出很強力的拳。", 193, ExpType.Slow, 45);
    ...
    DEX["喇叭芽"] = new PokemonType(basicStat, 69, new Image(pokemonImagePath + "069_喇叭芽.png"), new Image(pokemonImagePath + "069_喇叭芽_Back.png"), "喇叭芽", moves, Type.Grass, Type.Poison, "喜歡溫度高、有一定濕度的地方。用蔓藤抓住小蟲子吃掉。", 84, ExpType.Slow, 255);
    ...
    DEX["口呆花"] = new PokemonType(basicStat, 70, new Image(pokemonImagePath + "070_口呆花.png"), new Image(pokemonImagePath + "070_口呆花_Back.png"), "口呆花", moves, Type.Grass, Type.Poison, "肚子餓了就隨手抓到什麼會動的東西吞掉，用溶解液給予最後一擊。", 151, ExpType.Slow, 120);
    ...
    DEX["大食花"] = new PokemonType(basicStat, 71, new Image(pokemonImagePath + "071_大食花.png"), new Image(pokemonImagePath + "071_大食花_Back.png"), "大食花", moves, Type.Grass, Type.Poison, "用花蜜的香味引誘獵物。據說進到嘴裡的東西會在1天內連骨頭都被溶解掉。", 191, ExpType.Slow, 45);
    ...
    DEX["瑪瑙水母"] = new PokemonType(basicStat, 72, new Image(pokemonImagePath + "072_瑪瑙水母.png"), new Image(pokemonImagePath + "072_瑪瑙水母_Back.png"), "瑪瑙水母", moves, Type.Water, Type.Poison, "雖然也在海邊發現過干透的身體，但放回水裡的話，就會復活。", 105, ExpType.Slower, 190);
    ...
    DEX["隆隆石"] = new PokemonType(basicStat, 75, new Image(pokemonImagePath + "075_隆隆石.png"), new Image(pokemonImagePath + "075_隆隆石_Back.png"), "隆隆石", moves, Type.Rock, Type.Ground, "經常在山路上滾動。通過的路上的一切都視若無睹。", 134, ExpType.Slow, 120);

    basicStat = {maxHP: 80, attack: 110, defense: 130, special: 55, speed: 45};
    moves = [new GradingMove(undefined, MoveDEX["撞擊"]), new GradingMove(undefined, MoveDEX["變圓"]), new GradingMove(16, MoveDEX["落石"]), new GradingMove(21, MoveDEX["自爆"]), new GradingMove(29, MoveDEX["變硬"]), new GradingMove(36, MoveDEX["地震"]), new GradingMove(43, MoveDEX["大爆炸"])];
    DEX["隆隆岩"] = new PokemonType(basicStat, 76, new Image(pokemonImagePath + "076_隆隆岩.png"), new Image(pokemonImagePath + "076_隆隆岩_Back.png"), "隆隆岩", moves, Type.Rock, Type.Ground, "蛻皮的時候全身感覺很白很柔軟，但碰到空氣很快變硬。", 177, ExpType.Slow, 45);
    ...
    DEX["小火馬"] = new PokemonType(basicStat, 77, new Image(pokemonImagePath + "077_小火馬.png"), new Image(pokemonImagePath + "077_小火馬_Back.png"), "小火馬", moves, Type.Fire, undefined, "非常強的跳躍後，著地的撞擊用蹄子和腳的肌肉來緩解。", 152, ExpType.Fast, 190);
    ...
    DEX["烈焰馬"] = new PokemonType(basicStat, 78, new Image(pokemonImagePath + "078_烈焰馬.png"), new Image(pokemonImagePath + "078_烈焰馬_Back.png"), "烈焰馬", moves, Type.Fire, undefined, "總之最喜歡跑步，發現比自己快的東西就會全速追趕。", 192, ExpType.Fast, 60);
    ...
    DEX["呆呆獸"] = new PokemonType(basicStat, 79, new Image(pokemonImagePath + "079_呆呆獸.png"), new Image(pokemonImagePath + "079_呆呆獸_Back.png"), "呆呆獸", moves, Type.Water, Type.Phycsic, "非常呆，動作也很緩慢。不在意時間的流逝，悠閒地生活。", 99, ExpType.Fast, 190);
    ...
    DEX["呆殼獸"] = new PokemonType(basicStat, 80, new Image(pokemonImagePath + "080_呆殼獸.png"), new Image(pokemonImagePath + "080_呆殼獸_Back.png"), "呆殼獸", moves, Type.Water, Type.Phycsic, "悠閒地住在海邊，如果尾巴上的大舌貝脫落了就會變回呆呆獸。", 164, ExpType.Fast, 75);
    ...
    DEX["小磁怪"] = new PokemonType(basicStat, 81, new Image(pokemonImagePath + "081_小磁怪.png"), new Image(pokemonImagePath + "081_小磁怪_Back.png"), "小磁怪", moves, Type.Electric, undefined, "與生俱來擁有可以遮斷重力的能力。邊放出電磁波邊在空中移動。", 89, ExpType.Fast, 190);
    ...
    DEX["三合一磁怪"] = new PokemonType(basicStat, 82, new Image(pokemonImagePath + "082_三合一磁怪.png"), new Image(pokemonImagePath + "082_三合一磁怪_Back.png"), "三合一磁怪", moves, Type.Electric, undefined, "發射著神秘的電波，會讓半徑１公里範圍內的氣溫升高２度。", 161, ExpType.Fast, 60);
    ...
    DEX["大蔥鴨"] = new PokemonType(basicStat, 83, new Image(pokemonImagePath + "083_大蔥鴨.png"), new Image(pokemonImagePath + "083_大蔥鴨_Back.png"), "大蔥鴨", moves, Type.Normal, Type.Flying, "住在生長著植物莖的地方，因為很難見到數量也少，似乎從前就在減少了。", 94, ExpType.Fast, 45);
    ...
    DEX["嘟嘟"] = new PokemonType(basicStat, 84, new Image(pokemonImagePath + "084_嘟嘟.png"), new Image(pokemonImagePath + "084_嘟嘟_Back.png"), "嘟嘟", moves, Type.Normal, Type.Flying, "羽毛很短所以不擅于飛上天空，取而代之的是很發達的腿，可以跑得很快。", 96, ExpType.Fast, 190);
    ...
    DEX["嘟嘟利"] = new PokemonType(basicStat, 85, new Image(pokemonImagePath + "085_嘟嘟利.png"), new Image(pokemonImagePath + "085_嘟嘟利_Back.png"), "嘟嘟利", moves, Type.Normal, Type.Flying, "嘟嘟的某一個頭分裂出的變種，以時速60千米在草原上奔跑。", 158, ExpType.Fast, 45);
    ...
    DEX["小海獅"] = new PokemonType(basicStat, 86, new Image(pokemonImagePath + "086_小海獅.png"), new Image(pokemonImagePath + "086_小海獅_Back.png"), "小海獅", moves, Type.Water, undefined, "喜歡能把人凍成冰一樣寒冷的地方，會在冰點下10度左右很舒服地游泳。", 100, ExpType.Fast, 190);
    ...
    DEX["白海獅"] = new PokemonType(basicStat, 87, new Image(pokemonImagePath + "087_白海獅.png"), new Image(pokemonImagePath + "087_白海獅_Back.png"), "白海獅", moves, Type.Water, Type.Ice, "全身像雪一樣白。在寒冷的有浮冰的海面上也很有活力地游來游去。", 176, ExpType.Fast, 75);
    ...
    DEX["臭泥"] = new PokemonType(basicStat, 88, new Image(pokemonImagePath + "088_臭泥.png"), new Image(pokemonImagePath + "088_臭泥_Back.png"), "臭泥", moves, Type.Poison, undefined, "淤泥凝結而生。很臭不可以碰，通過後的痕跡也寸草不生。", 90, ExpType.Fast, 190);
    ...
    DEX["臭臭泥"] = new PokemonType(basicStat, 89, new Image(pokemonImagePath + "089_臭臭泥.png"), new Image(pokemonImagePath + "089_臭臭泥_Back.png"), "臭臭泥", moves, Type.Poison, undefined, "非常的臭！可以使人昏厥般強烈，但是臭臭泥的鼻子退化了聞不到味道。", 157, ExpType.Fast, 75);
    ...
    DEX["大舌貝"] = new PokemonType(basicStat, 90, new Image(pokemonImagePath + "090_大舌貝.png"), new Image(pokemonImagePath + "090_大舌貝_Back.png"), "大舌貝", moves, Type.Water, undefined, "雖然硬殼可以經受住任何攻擊，一旦打開，柔軟的內部就會變得一覽無遺。", 97, ExpType.Slower, 190);
    ...
    DEX["刺甲貝"] = new PokemonType(basicStat, 91, new Image(pokemonImagePath + "091_刺甲貝.png"), new Image(pokemonImagePath + "091_刺甲貝_Back.png"), "刺甲貝", moves, Type.Water, Type.Ice, "不僅僅有比鑽石還硬的殼保護著，還附著著會飛來的刺，相當難對付。", 203, ExpType.Slower, 60);
    ...
    DEX["鬼斯"] = new PokemonType(basicStat, 92, new Image(pokemonImagePath + "092_鬼斯.png"), new Image(pokemonImagePath + "092_鬼斯_Back.png"), "鬼斯", moves, Type.Ghost, Type.Poison, "好像會出現在很老舊的沒有人居住的建築裡。形狀不清像瓦斯一樣。", 95, ExpType.Slow, 190);
    ...
    DEX["鬼斯通"] = new PokemonType(basicStat, 93, new Image(pokemonImagePath + "093_鬼斯通.png"), new Image(pokemonImagePath + "093_鬼斯通_Back.png"), "鬼斯通", moves, Type.Ghost, Type.Poison, "據說被舔到的話命會被吸走。身體膽怯不止，死亡馬上就會來臨。", 126, ExpType.Slow, 90);

    basicStat = {maxHP: 60, attack: 65, defense: 60, special: 130, speed: 110};
    moves = [new GradingMove(undefined, MoveDEX["舌舔"]), new GradingMove(undefined, MoveDEX["奇異之光"]), new GradingMove(undefined, MoveDEX["黑夜魔影"]), new GradingMove(29, MoveDEX["催眠術"]), new GradingMove(38, MoveDEX["食夢"])];
    DEX["耿鬼"] = new PokemonType(basicStat, 94, new Image(pokemonImagePath + "094_耿鬼.png"), new Image(pokemonImagePath + "094_耿鬼_Back.png"), "耿鬼", moves, Type.Ghost, Type.Poison, "突然感覺冷時就是耿鬼在附近。有可能是它在下詛咒也說不定。", 190, ExpType.Slow, 45);
    ...
    DEX["大岩蛇"] = new PokemonType(basicStat, 95, new Image(pokemonImagePath + "095_大岩蛇.png"), new Image(pokemonImagePath + "095_大岩蛇_Back.png"), "大岩蛇", moves, Type.Rock, Type.Ground, "會在地下以驚人的勢頭挖洞前進尋找食物。通過後留下的洞穴會成為地鼠的巢穴。", 108, ExpType.Fast, 45);
    ...
    DEX["催眠貘"] = new PokemonType(basicStat, 96, new Image(pokemonImagePath + "096_催眠貘.png"), new Image(pokemonImagePath + "096_催眠貘_Back.png"), "催眠貘", moves, Type.Phycsic, undefined, "一直在一起睡覺的話，偶爾夜裡會讓你看它吃過的夢。", 102, ExpType.Fast, 190);
    ...
    DEX["引夢貘人"] = new PokemonType(basicStat, 97, new Image(pokemonImagePath + "097_引夢貘人.png"), new Image(pokemonImagePath + "097_引夢貘人_Back.png"), "引夢貘人", moves, Type.Phycsic, undefined, "不留神對上眼的話不把眼睛移開會很危險，手上拿著的擺會讓人睡著。", 165, ExpType.Fast, 75);
    ...
    DEX["大鉗蟹"] = new PokemonType(basicStat, 98, new Image(pokemonImagePath + "098_大鉗蟹.png"), new Image(pokemonImagePath + "098_大鉗蟹_Back.png"), "大鉗蟹", moves, Type.Water, undefined, "作為強力武器的鉗子在攻擊的時候很少會脫落，但之後立刻會長出來。", 115, ExpType.Fast, 225);
    ...
    DEX["巨鉗蟹"] = new PokemonType(basicStat, 99, new Image(pokemonImagePath + "099_巨鉗蟹.png"), new Image(pokemonImagePath + "099_巨鉗蟹_Back.png"), "巨鉗蟹", moves, Type.Water, undefined, "只有一邊有的巨大鉗子擁有鋼鐵的硬度和一萬馬力，卻十分之重。", 206, ExpType.Fast, 60);
    ...
    DEX["霹靂電球"] = new PokemonType(basicStat, 100, new Image(pokemonImagePath + "100_霹靂電球.png"), new Image(pokemonImagePath + "100_霹靂電球_Back.png"), "霹靂電球", moves, Type.Electric, undefined, "雖說據說長得像精靈球是因為保護色的緣故，但是意外地很容易自爆。", 103, ExpType.Fast, 190);
    ...
    DEX["頑皮雷彈"] = new PokemonType(basicStat, 101, new Image(pokemonImagePath + "101_頑皮雷彈.png"), new Image(pokemonImagePath + "101_頑皮雷彈_Back.png"), "頑皮雷彈", moves, Type.Electric, undefined, "只要受到一點撞擊，體內的電氣能量就會溢出而爆炸。", 150, ExpType.Fast, 60);
    ...
    DEX["蛋蛋"] = new PokemonType(basicStat, 102, new Image(pokemonImagePath + "102_蛋蛋.png"), new Image(pokemonImagePath + "102_蛋蛋_Back.png"), "蛋蛋", moves, Type.Grass, Type.Phycsic, "一個個蛋互相吸引旋轉，不是6個的話就無法安定。", 98, ExpType.Slower, 90);
    ...
    DEX["椰蛋樹"] = new PokemonType(basicStat, 103, new Image(pokemonImagePath + "103_椰蛋樹.png"), new Image(pokemonImagePath + "103_椰蛋樹_Back.png"), "椰蛋樹", moves, Type.Grass, Type.Phycsic, "鳴叫的聲音非常吵鬧，因為三個頭分別只想著自己喜歡的事情。", 212, ExpType.Slower, 45);
    ...
    DEX["卡拉卡拉"] = new PokemonType(basicStat, 104, new Image(pokemonImagePath + "104_卡拉卡拉.png"), new Image(pokemonImagePath + "104_卡拉卡拉_Back.png"), "卡拉卡拉", moves, Type.Ground, undefined, "戴著去世母親的頭骨。哭聲在骨頭裡迴響，成為讓人難過的旋律。", 87, ExpType.Fast, 190);
    ...
    DEX["嘎啦嘎啦"] = new PokemonType(basicStat, 105, new Image(pokemonImagePath + "105_嘎啦嘎啦.png"), new Image(pokemonImagePath + "105_嘎啦嘎啦_Back.png"), "嘎啦嘎啦", moves, Type.Ground, Type.Fire, "原本身體又小又弱，但熟練使用骨頭戰鬥之後，性格就變得凶暴了。", 124, ExpType.Fast, 75);
    ...
    DEX["飛腿郎"] = new PokemonType(basicStat, 106, new Image(pokemonImagePath + "106_飛腿郎.png"), new Image(pokemonImagePath + "106_飛腿郎_Back.png"), "飛腿郎", moves, Type.Fighting, undefined, "踢中只需瞬間！腿的內側變得像鑽石一樣硬，將對手擊破。", 139, ExpType.Fast, 45);
    ...
    DEX["快拳郎"] = new PokemonType(basicStat, 107, new Image(pokemonImagePath + "107_快拳郎.png"), new Image(pokemonImagePath + "107_快拳郎_Back.png"), "快拳郎", moves, Type.Fighting, undefined, "像扭轉般的拳攻擊！像鑽頭狀地打在混凝土牆上，很快就能開出一個洞。", 140, ExpType.Fast, 45);
    ...
    DEX["大舌頭"] = new PokemonType(basicStat, 108, new Image(pokemonImagePath + "108_大舌頭.png"), new Image(pokemonImagePath + "108_大舌頭_Back.png"), "大舌頭", moves, Type.Normal, undefined, "舌頭有兩米長，比前肢還靈巧地活動。被舔到的話不知為何會感到很麻。", 127, ExpType.Fast, 45);
    ...
    DEX["瓦斯彈"] = new PokemonType(basicStat, 109, new Image(pokemonImagePath + "109_瓦斯彈.png"), new Image(pokemonImagePath + "109_瓦斯彈_Back.png"), "瓦斯彈", moves, Type.Poison, undefined, "在熱的地方身體裡的瓦斯會膨脹破裂具有危險性，因此要注意。", 114, ExpType.Fast, 190);
    ...
    DEX["雙彈瓦斯"] = new PokemonType(basicStat, 110, new Image(pokemonImagePath + "110_雙彈瓦斯.png"), new Image(pokemonImagePath + "110_雙彈瓦斯_Back.png"), "雙彈瓦斯", moves, Type.Poison, undefined, "吸取垃圾裡含有的毒瓦斯、細菌和灰塵生存。", 173, ExpType.Fast, 60);
    ...
    DEX["獨角犀牛"] = new PokemonType(basicStat, 111, new Image(pokemonImagePath + "111_獨角犀牛.png"), new Image(pokemonImagePath + "111_獨角犀牛_Back.png"), "獨角犀牛", moves, Type.Ground, Type.Rock, "腦子只有一根筋所以只能考慮一件事。開始", 135, ExpType.Slower, 120);
    ...
    DEX["鑽角犀獸"] = new PokemonType(basicStat, 112, new Image(pokemonImagePath + "112_鑽角犀獸.png"), new Image(pokemonImagePath + "112_鑽角犀獸_Back.png"), "鑽角犀獸", moves, Type.Ground, Type.Rock, "可以用後腳行走，智力變得發達了。鎧甲般的皮膚連岩漿都能承受。", 204, ExpType.Slower, 60);
    ...
    DEX["吉利蛋"] = new PokemonType(basicStat, 113, new Image(pokemonImagePath + "113_吉利蛋.png"), new Image(pokemonImagePath + "113_吉利蛋_Back.png"), "吉利蛋", moves, Type.Normal, undefined, "看到受傷的人就會把營養豐富的蛋分給對方，很是溫柔的寶可夢。", 255, ExpType.Faster, 30);
    ...
    DEX["蔓藤怪"] = new PokemonType(basicStat, 114, new Image(pokemonImagePath + "114_蔓藤怪.png"), new Image(pokemonImagePath + "114_蔓藤怪_Back.png"), "蔓藤怪", moves, Type.Grass, undefined, "全身被藍色的蔓藤覆蓋，真面目不明。據說蔓藤會一直不斷伸長。", 166, ExpType.Fast, 45);
    ...
    DEX["袋獸"] = new PokemonType(basicStat, 115, new Image(pokemonImagePath + "115_袋獸.png"), new Image(pokemonImagePath + "115_袋獸_Back.png"), "袋獸", moves, Type.Normal, undefined, "在腹袋裡撫育寶寶。為了保護寶寶，無論任何敵人都會與之對抗。", 175, ExpType.Fast, 45);
    ...
    DEX["墨海馬"] = new PokemonType(basicStat, 116, new Image(pokemonImagePath + "116_墨海馬.png"), new Image(pokemonImagePath + "116_墨海馬_Back.png"), "墨海馬", moves, Type.Water, undefined, "感到危險近身時會從嘴裡有強勁地吐出水或者特殊的墨汁。", 83, ExpType.Fast, 225);
    ...
    DEX["海刺龍"] = new PokemonType(basicStat, 117, new Image(pokemonImagePath + "117_海刺龍.png"), new Image(pokemonImagePath + "117_海刺龍_Back.png"), "海刺龍", moves, Type.Water, undefined, "摸它的背鰭會被麻痺。睡覺時為了不被沖走，會用尾巴捲住珊瑚。", 155, ExpType.Fast, 75);
    ...
    DEX["角金魚"] = new PokemonType(basicStat, 118, new Image(pokemonImagePath + "118_角金魚.png"), new Image(pokemonImagePath + "118_角金魚_Back.png"), "角金魚", moves, Type.Water, undefined, "到了產卵期就可以看到逆流而上或攀登瀑布的角金魚群。", 111, ExpType.Fast, 225);
    ...
    DEX["金魚王"] = new PokemonType(basicStat, 119, new Image(pokemonImagePath + "119_金魚王.png"), new Image(pokemonImagePath + "119_金魚王_Back.png"), "金魚王", moves, Type.Water, undefined, "用頭上的角打穿河底的岩石築巢是雄性的職責。", 170, ExpType.Fast, 60);
    ...
    DEX["海星星"] = new PokemonType(basicStat, 120, new Image(pokemonImagePath + "120_海星星.png"), new Image(pokemonImagePath + "120_海星星_Back.png"), "海星星", moves, Type.Water, undefined, "據說就算只剩下身體中心的部分，無論被切得多小也可以再生。", 106, ExpType.Slower, 225);
    ...
    DEX["寶石海星"] = new PokemonType(basicStat, 121, new Image(pokemonImagePath + "121_寶石海星.png"), new Image(pokemonImagePath + "121_寶石海星_Back.png"), "寶石海星", moves, Type.Water, Type.Phycsic, "據說被稱作核心的中心部分閃爍七種顏色的時候是在通信。", 207, ExpType.Slower, 60);
    ...
    DEX["魔牆人偶"] = new PokemonType(basicStat, 122, new Image(pokemonImagePath + "122_魔牆人偶.png"), new Image(pokemonImagePath + "122_魔牆人偶_Back.png"), "魔牆人偶", moves, Type.Phycsic, undefined, "很擅長啞劇所以任何時候都在練習。就算空無一物也可以使人相信那裡真的有東西。", 136, ExpType.Fast, 45);
    ...
    DEX["飛天螳螂"] = new PokemonType(basicStat, 123, new Image(pokemonImagePath + "123_飛天螳螂.png"), new Image(pokemonImagePath + "123_飛天螳螂_Back.png"), "飛天螳螂", moves, Type.Bug, Type.Flying, "從草叢中突然跳出來，用鋒利的鐮刀切斬的樣子簡直像忍者一樣。", 187, ExpType.Fast, 45);
    ...
    DEX["迷唇姐"] = new PokemonType(basicStat, 124, new Image(pokemonImagePath + "124_迷唇姐.png"), new Image(pokemonImagePath + "124_迷唇姐_Back.png"), "迷唇姐", moves, Type.Ice, Type.Phycsic, "像帶著獨特的節奏跳舞一樣悠游自如行動，像扭著腰一樣走路。", 137, ExpType.Fast, 45);
    ...
    DEX["電擊獸"] = new PokemonType(basicStat, 125, new Image(pokemonImagePath + "125_電擊獸.png"), new Image(pokemonImagePath + "125_電擊獸_Back.png"), "電擊獸", moves, Type.Electric, undefined, "發生大規模停電的話，一定是電擊獸在發電廠吞食電力。", 156, ExpType.Fast, 45);
    ...
    DEX["鴨嘴火獸"] = new PokemonType(basicStat, 126, new Image(pokemonImagePath + "126_鴨嘴火獸.png"), new Image(pokemonImagePath + "126_鴨嘴火獸_Back.png"), "鴨嘴火獸", moves, Type.Fire, undefined, "出生在火山口。因為全身在燃燒，看上去像火球一樣。", 167, ExpType.Fast, 45);
    ...
    DEX["凱羅斯"] = new PokemonType(basicStat, 127, new Image(pokemonImagePath + "127_凱羅斯.png"), new Image(pokemonImagePath + "127_凱羅斯_Back.png"), "凱羅斯", moves, Type.Bug, undefined, "用角夾住力量全開！變冷時會無法活動，因此住在暖和的地方。", 200, ExpType.Slower, 45);
    ...
    DEX["肯泰羅"] = new PokemonType(basicStat, 128, new Image(pokemonImagePath + "128_肯泰羅.png"), new Image(pokemonImagePath + "128_肯泰羅_Back.png"), "肯泰羅", moves, Type.Normal, undefined, "精力充沛的粗暴的傢伙。開始跑的話直到撞上什麼為止，都一個勁兒地向各個方向猛衝。", 211, ExpType.Slower, 45);
    ...
    DEX["鯉魚王"] = new PokemonType(basicStat, 129, new Image(pokemonImagePath + "129_鯉魚王.png"), new Image(pokemonImagePath + "129_鯉魚王_Back.png"), "鯉魚王", moves, Type.Water, undefined, "因靠不住而聞名的寶可夢。會到海裡、河裡、池塘和水塘裡。", 20, ExpType.Slower, 255);
    ...
    DEX["暴鯉龍"] = new PokemonType(basicStat, 130, new Image(pokemonImagePath + "130_暴鯉龍.png"), new Image(pokemonImagePath + "130_暴鯉龍_Back.png"), "暴鯉龍", moves, Type.Water, Type.Flying, "性格野蠻又有破壞性。有著很久以前將城市燒毀記錄的恐怖寶可夢。", 214, ExpType.Slower, 45);
    ...
    DEX["拉普拉斯"] = new PokemonType(basicStat, 131, new Image(pokemonImagePath + "131_拉普拉斯.png"), new Image(pokemonImagePath + "131_拉普拉斯_Back.png"), "拉普拉斯", moves, Type.Water, Type.Ice, "有著可以理解人類語言的溫柔的心。在背上載人航海。", 219, ExpType.Slower, 45);

    basicStat = {maxHP: 48, attack: 48, defense: 48, special: 48, speed: 48};
    moves = [new GradingMove(undefined, MoveDEX["變身"])];
    DEX["百變怪"] = new PokemonType(basicStat, 132, new Image(pokemonImagePath + "132_百變怪.png"), new Image(pokemonImagePath + "132_百變怪_Back.png"), "百變怪", moves, Type.Normal, undefined, "看到對手的一瞬間，身體溶化並開始變化。幾乎可以變成與對方一樣的形態。", 61, ExpType.Fast, 35);
    ...
    DEX["伊布"] = new PokemonType(basicStat, 133, new Image(pokemonImagePath + "133_伊布.png"), new Image(pokemonImagePath + "133_伊布_Back.png"), "伊布", moves, Type.Normal, Type.Water, "由於基因不穩定，進化的可能多種多樣。只是生存數量很少。", 92, ExpType.Fast, 45);
    ...
    DEX["水伊布"] = new PokemonType(basicStat, 134, new Image(pokemonImagePath + "134_水伊布.png"), new Image(pokemonImagePath + "134_水伊布_Back.png"), "水伊布", moves, Type.Water, Type.Normal, "因為細胞組織與水分子相似，溶解在水中之後就看不到了。", 196, ExpType.Fast, 45);
    ...
    DEX["雷伊布"] = new PokemonType(basicStat, 135, new Image(pokemonImagePath + "135_雷伊布.png"), new Image(pokemonImagePath + "135_雷伊布_Back.png"), "雷伊布", moves, Type.Electric, Type.Normal, "稍微有點刺激就會叫聲或發怒。另外在心情發生變化的時候的時候就會儲存電力。", 197, ExpType.Fast, 45);
    ...
    DEX["火伊布"] = new PokemonType(basicStat, 136, new Image(pokemonImagePath + "136_火伊布.png"), new Image(pokemonImagePath + "136_火伊布_Back.png"), "火伊布", moves, Type.Fire, Type.Normal, "體內有火炎袋，會把吸入的氣體變成1700度的火焰，從口中吐出。", 198, ExpType.Fast, 45);
    ...
    DEX["多邊獸"] = new PokemonType(basicStat, 137, new Image(pokemonImagePath + "137_多邊獸.png"), new Image(pokemonImagePath + "137_多邊獸_Back.png"), "多邊獸", moves, Type.Normal, undefined, "被寄予希望成為唯一可以飛到宇宙空間的寶可夢，但是還沒有成功的例子。", 130, ExpType.Fast, 45);
    ...
    DEX["菊石獸"] = new PokemonType(basicStat, 138, new Image(pokemonImagePath + "138_菊石獸.png"), new Image(pokemonImagePath + "138_菊石獸_Back.png"), "菊石獸", moves, Type.Rock, Type.Water, "用在古代的海洋裡熟練地彎曲10條腿漂蕩的寶可夢的化石復原而來。", 99, ExpType.Fast, 45);
    ...
    DEX["多刺菊石獸"] = new PokemonType(basicStat, 139, new Image(pokemonImagePath + "139_多刺菊石獸.png"), new Image(pokemonImagePath + "139_多刺菊石獸_Back.png"), "多刺菊石獸", moves, Type.Rock, Type.Water, "雖然擁有鋒利的牙齒，但似乎因為殼太大無法順利移動而導致滅絕。", 199, ExpType.Fast, 45);
    ...
    DEX["化石盔"] = new PokemonType(basicStat, 140, new Image(pokemonImagePath + "140_化石盔.png"), new Image(pokemonImagePath + "140_化石盔_Back.png"), "化石盔", moves, Type.Rock, Type.Water, "從化石中再生出的寶可夢。在海底隱藏的時候用背上的眼睛看著周圍。", 99, ExpType.Fast, 45);
    ...
    DEX["鐮刀盔"] = new PokemonType(basicStat, 141, new Image(pokemonImagePath + "141_鐮刀盔.png"), new Image(pokemonImagePath + "141_鐮刀盔_Back.png"), "鐮刀盔", moves, Type.Rock, Type.Water, "會用纖細的身體快速游動。好像會用鐮刀撕裂捉到的獵物吸取體液。", 199, ExpType.Fast, 45);
    ...
    DEX["化石翼龍"] = new PokemonType(basicStat, 142, new Image(pokemonImagePath + "142_化石翼龍.png"), new Image(pokemonImagePath + "142_化石翼龍_Back.png"), "化石翼龍", moves, Type.Rock, Type.Flying, "用從琥珀中提取的遺傳因子，經過研究使之復活的遠古的兇猛寶可夢。", 202, ExpType.Slower, 45);
    ...
    DEX["卡比獸"] = new PokemonType(basicStat, 143, new Image(pokemonImagePath + "143_卡比獸.png"), new Image(pokemonImagePath + "143_卡比獸_Back.png"), "卡比獸", moves, Type.Normal, undefined, "就算有些發霉的東西也毫不在意地吃下去。肚子並不會吃壞。", 154, ExpType.Slower, 25);
    ...
    DEX["急凍鳥"] = new PokemonType(basicStat, 144, new Image(pokemonImagePath + "144_急凍鳥.png"), new Image(pokemonImagePath + "144_急凍鳥_Back.png"), "急凍鳥", moves, Type.Ice, Type.Flying, "把冬日天空的空氣中所含有的水分凍結，降下雪花的傳說的鳥寶可夢。", 215, ExpType.Slower, 3);
    ...
    DEX["閃電鳥"] = new PokemonType(basicStat, 145, new Image(pokemonImagePath + "145_閃電鳥.png"), new Image(pokemonImagePath + "145_閃電鳥_Back.png"), "閃電鳥", moves, Type.Electric, Type.Flying, "天空變得黑暗，連續降下雷電，結果是傳說的寶可夢出現了。", 216, ExpType.Slower, 3);
    ...
    DEX["火焰鳥"] = new PokemonType(basicStat, 146, new Image(pokemonImagePath + "146_火焰鳥.png"), new Image(pokemonImagePath + "146_火焰鳥_Back.png"), "火焰鳥", moves, Type.Fire, Type.Flying, "拍動就連夜空也可以點亮的劇烈燃燒的翅膀，傳說的鳥寶可夢。", 217, ExpType.Slower, 3);
    ...
    DEX["迷你龍"] = new PokemonType(basicStat, 147, new Image(pokemonImagePath + "147_迷你龍.png"), new Image(pokemonImagePath + "147_迷你龍_Back.png"), "迷你龍", moves, Type.Dragon, undefined, "一直被認為是幻影，但最近被釣上來了，從而確認了它的存在。", 67, ExpType.Slower, 45);
    ...
    DEX["哈克龍"] = new PokemonType(basicStat, 148, new Image(pokemonImagePath + "148_哈克龍.png"), new Image(pokemonImagePath + "148_哈克龍_Back.png"), "哈克龍", moves, Type.Dragon, Type.Normal, "根據目擊者所述，從身體中放出氣場，據說非常神秘。", 144, ExpType.Slower, 45);
    ...
    DEX["快龍"] = new PokemonType(basicStat, 149, new Image(pokemonImagePath + "149_快龍.png"), new Image(pokemonImagePath + "149_快龍_Back.png"), "快龍", moves, Type.Dragon, Type.Flying, "雖然據說居住在浩瀚大海的某處，用飛行的方式移動，但終究不過是傳言。", 218, ExpType.Slower, 45);
    ...
    DEX["超夢"] = new PokemonType(basicStat, 150, new Image(pokemonImagePath + "150_超夢.png"), new Image(pokemonImagePath + "150_超夢_Back.png"), "超夢", moves, Type.Phycsic, undefined, "基因和夢幻幾乎一樣，但是大小和性格迥異到可怕。", 220, ExpType.Slower, 3);
    ...
    DEX["夢幻"] = new PokemonType(basicStat, 151, new Image(pokemonImagePath + "151_夢幻.png"), new Image(pokemonImagePath + "151_夢幻_Back.png"), "夢幻", moves, Type.Phycsic, undefined, "用顯微鏡看的話，能看到身上覆蓋著非常細小的短體毛。", 64, ExpType.Slow, 45);
