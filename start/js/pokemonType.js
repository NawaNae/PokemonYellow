...
(() => {
    ...
    DEX["妙蛙種子"] = new PokemonType(basicStat, 1, new Image(pokemonImagePath + "001_妙蛙種子.png"), new Image(pokemonImagePath + "001_妙蛙種子_Back.png"), "妙蛙種子", moves);
    ...
    DEX["妙蛙草"] = new PokemonType(basicStat, 2, new Image(pokemonImagePath + "002_妙蛙草.png"), new Image(pokemonImagePath + "002_妙蛙草_Back.png"), "妙蛙草", moves);
    ...
    DEX["妙蛙花"] = new PokemonType(basicStat, 3, new Image(pokemonImagePath + "003_妙蛙花.png"), new Image(pokemonImagePath + "003_妙蛙花_Back.png"), "妙蛙花", moves);
    ...
    DEX["小火龍"] = new PokemonType(basicStat, 4, new Image(pokemonImagePath + "004_小火龍.png"), new Image(pokemonImagePath + "004_小火龍_Back.png"), "小火龍", moves);
    ...
    DEX["火恐龍"] = new PokemonType(basicStat, 5, new Image(pokemonImagePath + "005_火恐龍.png"), new Image(pokemonImagePath + "005_火恐龍_Back.png"), "火恐龍", moves);
    ...
    DEX["噴火龍"] = new PokemonType(basicStat, 6, new Image(pokemonImagePath + "006_噴火龍.png"), new Image(pokemonImagePath + "006_噴火龍_Back.png"), "噴火龍", moves);
    ...
    DEX["傑尼龜"] = new PokemonType(basicStat, 7, new Image(pokemonImagePath + "007_傑尼龜.png"), new Image(pokemonImagePath + "007_傑尼龜_Back.png"), "傑尼龜", moves);
    ...
    DEX["卡咪龜"] = new PokemonType(basicStat, 8, new Image(pokemonImagePath + "008_卡咪龜.png"), new Image(pokemonImagePath + "008_卡咪龜_Back.png"), "卡咪龜", moves);
    ...
    DEX["水箭龜"] = new PokemonType(basicStat, 9, new Image(pokemonImagePath + "009_水箭龜.png"), new Image(pokemonImagePath + "009_水箭龜_Back.png"), "水箭龜", moves);
    ...
    DEX["綠毛蟲"] = new PokemonType(basicStat, 10, new Image(pokemonImagePath + "010_綠毛蟲.png"), new Image(pokemonImagePath + "010_綠毛蟲_Back.png"), "綠毛蟲", moves);
    ...
    DEX["鐵甲蛹"] = new PokemonType(basicStat, 11, new Image(pokemonImagePath + "011_鐵甲蛹.png"), new Image(pokemonImagePath + "011_鐵甲蛹_Back.png"), "鐵甲蛹", moves);
    ...
    DEX["巴大蝶"] = new PokemonType(basicStat, 12, new Image(pokemonImagePath + "012_巴大蝶.png"), new Image(pokemonImagePath + "012_巴大蝶_Back.png"), "巴大蝶", moves);
    ...
    DEX["獨角蟲"] = new PokemonType(basicStat, 13, new Image(pokemonImagePath + "013_獨角蟲.png"), new Image(pokemonImagePath + "013_獨角蟲_Back.png"), "獨角蟲", moves);

    basicStat = {maxHP: 45, attack: 25, defense: 50, special: 25, speed: 35};
    moves = [new GradingMove(undefined, MoveDEX["變硬"])];
    DEX["鐵殼蛹"] = new PokemonType(basicStat, 14, new Image(pokemonImagePath + "014_鐵殼蛹.png"), new Image(pokemonImagePath + "014_鐵殼蛹_Back.png"), "鐵殼蛹", moves);
    ...
    DEX["大針蜂"] = new PokemonType(basicStat, 15, new Image(pokemonImagePath + "015_大針蜂.png"), new Image(pokemonImagePath + "015_大針蜂_Back.png"), "大針蜂", moves);
    ...
    DEX["波波"] = new PokemonType(basicStat, 16, new Image(pokemonImagePath + "016_波波.png"), new Image(pokemonImagePath + "016_波波_Back.png"), "波波", moves);
    ...
    DEX["比比鳥"] = new PokemonType(basicStat, 17, new Image(pokemonImagePath + "017_比比鳥.png"), new Image(pokemonImagePath + "017_比比鳥_Back.png"), "比比鳥", moves);
    ...
    DEX["大比鳥"] = new PokemonType(basicStat, 18, new Image(pokemonImagePath + "018_大比鳥.png"), new Image(pokemonImagePath + "018_大比鳥_Back.png"), "大比鳥", moves);
    ...
    DEX["小拉達"] = new PokemonType(basicStat, 19, new Image(pokemonImagePath + "019_小拉達.png"), new Image(pokemonImagePath + "019_小拉達_Back.png"), "小拉達", moves);
    ...
    DEX["拉達"] = new PokemonType(basicStat, 20, new Image(pokemonImagePath + "020_拉達.png"), new Image(pokemonImagePath + "020_拉達_Back.png"), "拉達", moves);
    ...
    DEX["烈雀"] = new PokemonType(basicStat, 21, new Image(pokemonImagePath + "021_烈雀.png"), new Image(pokemonImagePath + "021_烈雀_Back.png"), "烈雀", moves);
    ...
    DEX["大嘴雀"] = new PokemonType(basicStat, 22, new Image(pokemonImagePath + "022_大嘴雀.png"), new Image(pokemonImagePath + "022_大嘴雀_Back.png"), "大嘴雀", moves);
    ...
    DEX["阿柏蛇"] = new PokemonType(basicStat, 23, new Image(pokemonImagePath + "023_阿柏蛇.png"), new Image(pokemonImagePath + "023_阿柏蛇_Back.png"), "阿柏蛇", moves);
    ...
    DEX["阿柏怪"] = new PokemonType(basicStat, 24, new Image(pokemonImagePath + "024_阿柏怪.png"), new Image(pokemonImagePath + "024_阿柏怪_Back.png"), "阿柏怪", moves);
    ...
    DEX["皮卡丘"] = new PokemonType(basicStat, 25, new Image(pokemonImagePath + "025_皮卡丘.png"), new Image(pokemonImagePath + "025_皮卡丘_Back.png"), "皮卡丘", moves);
    ...
    DEX["雷丘"] = new PokemonType(basicStat, 26, new Image(pokemonImagePath + "026_雷丘.png"), new Image(pokemonImagePath + "026_雷丘_Back.png"), "雷丘", moves);
    ...
    DEX["穿山鼠"] = new PokemonType(basicStat, 27, new Image(pokemonImagePath + "027_穿山鼠.png"), new Image(pokemonImagePath + "027_穿山鼠_Back.png"), "穿山鼠", moves);
    ...
    DEX["穿山王"] = new PokemonType(basicStat, 28, new Image(pokemonImagePath + "028_穿山王.png"), new Image(pokemonImagePath + "028_穿山王_Back.png"), "穿山王", moves);
    ...
    DEX["尼多蘭"] = new PokemonType(basicStat, 29, new Image(pokemonImagePath + "029_尼多蘭.png"), new Image(pokemonImagePath + "029_尼多蘭_Back.png"), "尼多蘭", moves);
    ...
    DEX["尼多娜"] = new PokemonType(basicStat, 30, new Image(pokemonImagePath + "030_尼多娜.png"), new Image(pokemonImagePath + "030_尼多娜_Back.png"), "尼多娜", moves);
    ...
    DEX["尼多后"] = new PokemonType(basicStat, 31, new Image(pokemonImagePath + "031_尼多后.png"), new Image(pokemonImagePath + "031_尼多后_Back.png"), "尼多后", moves);
    ...
    DEX["尼多朗"] = new PokemonType(basicStat, 32, new Image(pokemonImagePath + "032_尼多朗.png"), new Image(pokemonImagePath + "032_尼多朗_Back.png"), "尼多朗", moves);
    ...
    DEX["尼多力諾"] = new PokemonType(basicStat, 33, new Image(pokemonImagePath + "033_尼多力諾.png"), new Image(pokemonImagePath + "033_尼多力諾_Back.png"), "尼多力諾", moves);
    ...
    DEX["尼多王"] = new PokemonType(basicStat, 34, new Image(pokemonImagePath + "034_尼多王.png"), new Image(pokemonImagePath + "034_尼多王_Back.png"), "尼多王", moves);
    ...
    DEX["皮皮"] = new PokemonType(basicStat, 35, new Image(pokemonImagePath + "035_皮皮.png"), new Image(pokemonImagePath + "035_皮皮_Back.png"), "皮皮", moves);
    ...
    DEX["皮可西"] = new PokemonType(basicStat, 36, new Image(pokemonImagePath + "036_皮可西.png"), new Image(pokemonImagePath + "036_皮可西_Back.png"), "皮可西", moves);
    ...
    DEX["六尾"] = new PokemonType(basicStat, 37, new Image(pokemonImagePath + "037_六尾.png"), new Image(pokemonImagePath + "037_六尾_Back.png"), "六尾", moves);
    ...
    DEX["九尾"] = new PokemonType(basicStat, 38, new Image(pokemonImagePath + "038_九尾.png"), new Image(pokemonImagePath + "038_九尾_Back.png"), "九尾", moves);
    ...
    DEX["胖丁"] = new PokemonType(basicStat, 39, new Image(pokemonImagePath + "039_胖丁.png"), new Image(pokemonImagePath + "039_胖丁_Back.png"), "胖丁", moves);
    ...
    DEX["胖可丁"] = new PokemonType(basicStat, 40, new Image(pokemonImagePath + "040_胖可丁.png"), new Image(pokemonImagePath + "040_胖可丁_Back.png"), "胖可丁", moves);
    ...
    DEX["超音蝠"] = new PokemonType(basicStat, 41, new Image(pokemonImagePath + "041_超音蝠.png"), new Image(pokemonImagePath + "041_超音蝠_Back.png"), "超音蝠", moves);
    ...
    DEX["大嘴蝠"] = new PokemonType(basicStat, 42, new Image(pokemonImagePath + "042_大嘴蝠.png"), new Image(pokemonImagePath + "042_大嘴蝠_Back.png"), "大嘴蝠", moves);
    ...
    DEX["走路草"] = new PokemonType(basicStat, 43, new Image(pokemonImagePath + "043_走路草.png"), new Image(pokemonImagePath + "043_走路草_Back.png"), "走路草", moves);
    ...
    DEX["臭臭花"] = new PokemonType(basicStat, 44, new Image(pokemonImagePath + "044_臭臭花.png"), new Image(pokemonImagePath + "044_臭臭花_Back.png"), "臭臭花", moves);
    ...
    DEX["霸王花"] = new PokemonType(basicStat, 45, new Image(pokemonImagePath + "045_霸王花.png"), new Image(pokemonImagePath + "045_霸王花_Back.png"), "霸王花", moves);
    ...
    DEX["派拉斯"] = new PokemonType(basicStat, 46, new Image(pokemonImagePath + "046_派拉斯.png"), new Image(pokemonImagePath + "046_派拉斯_Back.png"), "派拉斯", moves);
    ...
    DEX["派拉斯特"] = new PokemonType(basicStat, 47, new Image(pokemonImagePath + "047_派拉斯特.png"), new Image(pokemonImagePath + "047_派拉斯特_Back.png"), "派拉斯特", moves);
    ...
    DEX["毛球"] = new PokemonType(basicStat, 48, new Image(pokemonImagePath + "048_毛球.png"), new Image(pokemonImagePath + "048_毛球_Back.png"), "毛球", moves);
    ...
    DEX["摩魯蛾"] = new PokemonType(basicStat, 49, new Image(pokemonImagePath + "049_摩魯蛾.png"), new Image(pokemonImagePath + "049_摩魯蛾_Back.png"), "摩魯蛾", moves);
    ...
    DEX["地鼠"] = new PokemonType(basicStat, 50, new Image(pokemonImagePath + "050_地鼠.png"), new Image(pokemonImagePath + "050_地鼠_Back.png"), "地鼠", moves);
    ...
    DEX["三地鼠"] = new PokemonType(basicStat, 51, new Image(pokemonImagePath + "051_三地鼠.png"), new Image(pokemonImagePath + "051_三地鼠_Back.png"), "三地鼠", moves);
    ...
    DEX["喵喵"] = new PokemonType(basicStat, 52, new Image(pokemonImagePath + "052_喵喵.png"), new Image(pokemonImagePath + "052_喵喵_Back.png"), "喵喵", moves);
    ...
    DEX["貓老大"] = new PokemonType(basicStat, 53, new Image(pokemonImagePath + "053_貓老大.png"), new Image(pokemonImagePath + "053_貓老大_Back.png"), "貓老大", moves);
    ...
    DEX["可達鴨"] = new PokemonType(basicStat, 54, new Image(pokemonImagePath + "054_可達鴨.png"), new Image(pokemonImagePath + "054_可達鴨_Back.png"), "可達鴨", moves);
    ...
    DEX["哥達鴨"] = new PokemonType(basicStat, 55, new Image(pokemonImagePath + "055_哥達鴨.png"), new Image(pokemonImagePath + "055_哥達鴨_Back.png"), "哥達鴨", moves);
    ...
    DEX["猴怪"] = new PokemonType(basicStat, 56, new Image(pokemonImagePath + "056_猴怪.png"), new Image(pokemonImagePath + "056_猴怪_Back.png"), "猴怪", moves);
    ...
    DEX["火爆猴"] = new PokemonType(basicStat, 57, new Image(pokemonImagePath + "057_火爆猴.png"), new Image(pokemonImagePath + "057_火爆猴_Back.png"), "火爆猴", moves);
    ...
    DEX["卡蒂狗"] = new PokemonType(basicStat, 58, new Image(pokemonImagePath + "058_卡蒂狗.png"), new Image(pokemonImagePath + "058_卡蒂狗_Back.png"), "卡蒂狗", moves);
    ...
    DEX["風速狗"] = new PokemonType(basicStat, 59, new Image(pokemonImagePath + "059_風速狗.png"), new Image(pokemonImagePath + "059_風速狗_Back.png"), "風速狗", moves);
    ...
    DEX["蚊香蝌蚪"] = new PokemonType(basicStat, 60, new Image(pokemonImagePath + "060_蚊香蝌蚪.png"), new Image(pokemonImagePath + "060_蚊香蝌蚪_Back.png"), "蚊香蝌蚪", moves);
    ...
    DEX["蚊香君"] = new PokemonType(basicStat, 61, new Image(pokemonImagePath + "061_蚊香君.png"), new Image(pokemonImagePath + "061_蚊香君_Back.png"), "蚊香君", moves);
    ...
    DEX["蚊香泳士"] = new PokemonType(basicStat, 62, new Image(pokemonImagePath + "062_蚊香泳士.png"), new Image(pokemonImagePath + "062_蚊香泳士_Back.png"), "蚊香泳士", moves);

    basicStat = {maxHP: 25, attack: 20, defense: 15, special: 105, speed: 90};
    moves = [new GradingMove(undefined, MoveDEX["瞬間移動"])];
    DEX["凱西"] = new PokemonType(basicStat, 63, new Image(pokemonImagePath + "063_凱西.png"), new Image(pokemonImagePath + "063_凱西_Back.png"), "凱西", moves);
    ...
    DEX["勇基拉"] = new PokemonType(basicStat, 64, new Image(pokemonImagePath + "064_勇基拉.png"), new Image(pokemonImagePath + "064_勇基拉_Back.png"), "勇基拉", moves);

    basicStat = {maxHP: 55, attack: 50, defense: 45, special: 135, speed: 120};
    moves = [new GradingMove(undefined, MoveDEX["瞬間移動"]), new GradingMove(undefined, MoveDEX["折彎湯匙"]), new GradingMove(16, MoveDEX["念力"]), new GradingMove(20, MoveDEX["定身法"]), new GradingMove(27, MoveDEX["幻象光線"]), new GradingMove(31, MoveDEX["自我再生"]), new GradingMove(38, MoveDEX["精神強念"]), new GradingMove(42, MoveDEX["反射壁"])];
    DEX["胡地"] = new PokemonType(basicStat, 65, new Image(pokemonImagePath + "065_胡地.png"), new Image(pokemonImagePath + "065_胡地_Back.png"), "胡地", moves);
    ...
    DEX["腕力"] = new PokemonType(basicStat, 66, new Image(pokemonImagePath + "066_腕力.png"), new Image(pokemonImagePath + "066_腕力_Back.png"), "腕力", moves);
    ...
    DEX["豪力"] = new PokemonType(basicStat, 67, new Image(pokemonImagePath + "067_豪力.png"), new Image(pokemonImagePath + "067_豪力_Back.png"), "豪力", moves);

    basicStat = {maxHP: 90, attack: 130, defense: 80, special: 65, speed: 55};
    moves = [new GradingMove(undefined, MoveDEX["空手劈"]), new GradingMove(undefined, MoveDEX["踢倒"]), new GradingMove(undefined, MoveDEX["瞪眼"]), new GradingMove(20, MoveDEX["踢倒"]), new GradingMove(25, MoveDEX["瞪眼"]), new GradingMove(36, MoveDEX["聚氣"]), new GradingMove(44, MoveDEX["地球上投"]), new GradingMove(52, MoveDEX["地獄翻滾"])];
    DEX["怪力"] = new PokemonType(basicStat, 68, new Image(pokemonImagePath + "068_怪力.png"), new Image(pokemonImagePath + "068_怪力_Back.png"), "怪力", moves);
    ...
    DEX["喇叭芽"] = new PokemonType(basicStat, 69, new Image(pokemonImagePath + "069_喇叭芽.png"), new Image(pokemonImagePath + "069_喇叭芽_Back.png"), "喇叭芽", moves);
    ...
    DEX["口呆花"] = new PokemonType(basicStat, 70, new Image(pokemonImagePath + "070_口呆花.png"), new Image(pokemonImagePath + "070_口呆花_Back.png"), "口呆花", moves);
    ...
    DEX["大食花"] = new PokemonType(basicStat, 71, new Image(pokemonImagePath + "071_大食花.png"), new Image(pokemonImagePath + "071_大食花_Back.png"), "大食花", moves);
    ...
    DEX["瑪瑙水母"] = new PokemonType(basicStat, 72, new Image(pokemonImagePath + "072_瑪瑙水母.png"), new Image(pokemonImagePath + "072_瑪瑙水母_Back.png"), "瑪瑙水母", moves);
    ...
    DEX["毒刺水母"] = new PokemonType(basicStat, 73, new Image(pokemonImagePath + "073_毒刺水母.png"), new Image(pokemonImagePath + "073_毒刺水母_Back.png"), "毒刺水母", moves);
    ...
    DEX["小拳石"] = new PokemonType(basicStat, 74, new Image(pokemonImagePath + "074_小拳石.png"), new Image(pokemonImagePath + "074_小拳石_Back.png"), "小拳石", moves);
    ...
    DEX["隆隆石"] = new PokemonType(basicStat, 75, new Image(pokemonImagePath + "075_隆隆石.png"), new Image(pokemonImagePath + "075_隆隆石_Back.png"), "隆隆石", moves);

    basicStat = {maxHP: 80, attack: 110, defense: 130, special: 55, speed: 45};
    moves = [new GradingMove(undefined, MoveDEX["撞擊"]), new GradingMove(undefined, MoveDEX["變圓"]), new GradingMove(16, MoveDEX["落石"]), new GradingMove(21, MoveDEX["自爆"]), new GradingMove(29, MoveDEX["變硬"]), new GradingMove(36, MoveDEX["地震"]), new GradingMove(43, MoveDEX["大爆炸"])];
    DEX["隆隆岩"] = new PokemonType(basicStat, 76, new Image(pokemonImagePath + "076_隆隆岩.png"), new Image(pokemonImagePath + "076_隆隆岩_Back.png"), "隆隆岩", moves);
    ...
    DEX["小火馬"] = new PokemonType(basicStat, 77, new Image(pokemonImagePath + "077_小火馬.png"), new Image(pokemonImagePath + "077_小火馬_Back.png"), "小火馬", moves);
    ...
    DEX["烈焰馬"] = new PokemonType(basicStat, 78, new Image(pokemonImagePath + "078_烈焰馬.png"), new Image(pokemonImagePath + "078_烈焰馬_Back.png"), "烈焰馬", moves);
    ...
    DEX["呆呆獸"] = new PokemonType(basicStat, 79, new Image(pokemonImagePath + "079_呆呆獸.png"), new Image(pokemonImagePath + "079_呆呆獸_Back.png"), "呆呆獸", moves);
    ...
    DEX["呆殼獸"] = new PokemonType(basicStat, 80, new Image(pokemonImagePath + "080_呆殼獸.png"), new Image(pokemonImagePath + "080_呆殼獸_Back.png"), "呆殼獸", moves);
    ...
    DEX["小磁怪"] = new PokemonType(basicStat, 81, new Image(pokemonImagePath + "081_小磁怪.png"), new Image(pokemonImagePath + "081_小磁怪_Back.png"), "小磁怪", moves);
    ...
    DEX["三合一磁怪"] = new PokemonType(basicStat, 82, new Image(pokemonImagePath + "082_三合一磁怪.png"), new Image(pokemonImagePath + "082_三合一磁怪_Back.png"), "三合一磁怪", moves);
    ...
    DEX["大蔥鴨"] = new PokemonType(basicStat, 83, new Image(pokemonImagePath + "083_大蔥鴨.png"), new Image(pokemonImagePath + "083_大蔥鴨_Back.png"), "大蔥鴨", moves);
    ...
    DEX["嘟嘟"] = new PokemonType(basicStat, 84, new Image(pokemonImagePath + "084_嘟嘟.png"), new Image(pokemonImagePath + "084_嘟嘟_Back.png"), "嘟嘟", moves);
    ...
    DEX["嘟嘟利"] = new PokemonType(basicStat, 85, new Image(pokemonImagePath + "085_嘟嘟利.png"), new Image(pokemonImagePath + "085_嘟嘟利_Back.png"), "嘟嘟利", moves);
    ...
    DEX["小海獅"] = new PokemonType(basicStat, 86, new Image(pokemonImagePath + "086_小海獅.png"), new Image(pokemonImagePath + "086_小海獅_Back.png"), "小海獅", moves);
    ...
    DEX["白海獅"] = new PokemonType(basicStat, 87, new Image(pokemonImagePath + "087_白海獅.png"), new Image(pokemonImagePath + "087_白海獅_Back.png"), "白海獅", moves);
    ...
    DEX["臭泥"] = new PokemonType(basicStat, 88, new Image(pokemonImagePath + "088_臭泥.png"), new Image(pokemonImagePath + "088_臭泥_Back.png"), "臭泥", moves);
    ...
    DEX["臭臭泥"] = new PokemonType(basicStat, 89, new Image(pokemonImagePath + "089_臭臭泥.png"), new Image(pokemonImagePath + "089_臭臭泥_Back.png"), "臭臭泥", moves);
    ...
    DEX["大舌貝"] = new PokemonType(basicStat, 90, new Image(pokemonImagePath + "090_大舌貝.png"), new Image(pokemonImagePath + "090_大舌貝_Back.png"), "大舌貝", moves);
    ...
    DEX["刺甲貝"] = new PokemonType(basicStat, 91, new Image(pokemonImagePath + "091_刺甲貝.png"), new Image(pokemonImagePath + "091_刺甲貝_Back.png"), "刺甲貝", moves);
    ...
    DEX["鬼斯"] = new PokemonType(basicStat, 92, new Image(pokemonImagePath + "092_鬼斯.png"), new Image(pokemonImagePath + "092_鬼斯_Back.png"), "鬼斯", moves);
    ...
    DEX["鬼斯通"] = new PokemonType(basicStat, 93, new Image(pokemonImagePath + "093_鬼斯通.png"), new Image(pokemonImagePath + "093_鬼斯通_Back.png"), "鬼斯通", moves);

    basicStat = {maxHP: 60, attack: 65, defense: 60, special: 130, speed: 110};
    moves = [new GradingMove(undefined, MoveDEX["舌舔"]), new GradingMove(undefined, MoveDEX["奇異之光"]), new GradingMove(undefined, MoveDEX["黑夜魔影"]), new GradingMove(29, MoveDEX["催眠術"]), new GradingMove(38, MoveDEX["食夢"])];
    DEX["耿鬼"] = new PokemonType(basicStat, 94, new Image(pokemonImagePath + "094_耿鬼.png"), new Image(pokemonImagePath + "094_耿鬼_Back.png"), "耿鬼", moves);
    ...
    DEX["大岩蛇"] = new PokemonType(basicStat, 95, new Image(pokemonImagePath + "095_大岩蛇.png"), new Image(pokemonImagePath + "095_大岩蛇_Back.png"), "大岩蛇", moves);
    ...
    DEX["催眠貘"] = new PokemonType(basicStat, 96, new Image(pokemonImagePath + "096_催眠貘.png"), new Image(pokemonImagePath + "096_催眠貘_Back.png"), "催眠貘", moves);
    ...
    DEX["引夢貘人"] = new PokemonType(basicStat, 97, new Image(pokemonImagePath + "097_引夢貘人.png"), new Image(pokemonImagePath + "097_引夢貘人_Back.png"), "引夢貘人", moves);
    ...
    DEX["大鉗蟹"] = new PokemonType(basicStat, 98, new Image(pokemonImagePath + "098_大鉗蟹.png"), new Image(pokemonImagePath + "098_大鉗蟹_Back.png"), "大鉗蟹", moves);
    ...
    DEX["巨鉗蟹"] = new PokemonType(basicStat, 99, new Image(pokemonImagePath + "099_巨鉗蟹.png"), new Image(pokemonImagePath + "099_巨鉗蟹_Back.png"), "巨鉗蟹", moves);
    ...
    DEX["霹靂電球"] = new PokemonType(basicStat, 100, new Image(pokemonImagePath + "100_霹靂電球.png"), new Image(pokemonImagePath + "100_霹靂電球_Back.png"), "霹靂電球", moves);
    ...
    DEX["頑皮雷彈"] = new PokemonType(basicStat, 101, new Image(pokemonImagePath + "101_頑皮雷彈.png"), new Image(pokemonImagePath + "101_頑皮雷彈_Back.png"), "頑皮雷彈", moves);
    ...
    DEX["蛋蛋"] = new PokemonType(basicStat, 102, new Image(pokemonImagePath + "102_蛋蛋.png"), new Image(pokemonImagePath + "102_蛋蛋_Back.png"), "蛋蛋", moves);
    ...
    DEX["椰蛋樹"] = new PokemonType(basicStat, 103, new Image(pokemonImagePath + "103_椰蛋樹.png"), new Image(pokemonImagePath + "103_椰蛋樹_Back.png"), "椰蛋樹", moves);
    ...
    DEX["卡拉卡拉"] = new PokemonType(basicStat, 104, new Image(pokemonImagePath + "104_卡拉卡拉.png"), new Image(pokemonImagePath + "104_卡拉卡拉_Back.png"), "卡拉卡拉", moves);
    ...
    DEX["嘎啦嘎啦"] = new PokemonType(basicStat, 105, new Image(pokemonImagePath + "105_嘎啦嘎啦.png"), new Image(pokemonImagePath + "105_嘎啦嘎啦_Back.png"), "嘎啦嘎啦", moves);
    ...
    DEX["飛腿郎"] = new PokemonType(basicStat, 106, new Image(pokemonImagePath + "106_飛腿郎.png"), new Image(pokemonImagePath + "106_飛腿郎_Back.png"), "飛腿郎", moves);
    ...
    DEX["快拳郎"] = new PokemonType(basicStat, 107, new Image(pokemonImagePath + "107_快拳郎.png"), new Image(pokemonImagePath + "107_快拳郎_Back.png"), "快拳郎", moves);
    ...
    DEX["大舌頭"] = new PokemonType(basicStat, 108, new Image(pokemonImagePath + "108_大舌頭.png"), new Image(pokemonImagePath + "108_大舌頭_Back.png"), "大舌頭", moves);
    ...
    DEX["瓦斯彈"] = new PokemonType(basicStat, 109, new Image(pokemonImagePath + "109_瓦斯彈.png"), new Image(pokemonImagePath + "109_瓦斯彈_Back.png"), "瓦斯彈", moves);
    ...
    DEX["雙彈瓦斯"] = new PokemonType(basicStat, 110, new Image(pokemonImagePath + "110_雙彈瓦斯.png"), new Image(pokemonImagePath + "110_雙彈瓦斯_Back.png"), "雙彈瓦斯", moves);
    ...
    DEX["獨角犀牛"] = new PokemonType(basicStat, 111, new Image(pokemonImagePath + "111_獨角犀牛.png"), new Image(pokemonImagePath + "111_獨角犀牛_Back.png"), "獨角犀牛", moves);
    ...
    DEX["鑽角犀獸"] = new PokemonType(basicStat, 112, new Image(pokemonImagePath + "112_鑽角犀獸.png"), new Image(pokemonImagePath + "112_鑽角犀獸_Back.png"), "鑽角犀獸", moves);
    ...
    DEX["吉利蛋"] = new PokemonType(basicStat, 113, new Image(pokemonImagePath + "113_吉利蛋.png"), new Image(pokemonImagePath + "113_吉利蛋_Back.png"), "吉利蛋", moves);
    ...
    DEX["蔓藤怪"] = new PokemonType(basicStat, 114, new Image(pokemonImagePath + "114_蔓藤怪.png"), new Image(pokemonImagePath + "114_蔓藤怪_Back.png"), "蔓藤怪", moves);
    ...
    DEX["袋獸"] = new PokemonType(basicStat, 115, new Image(pokemonImagePath + "115_袋獸.png"), new Image(pokemonImagePath + "115_袋獸_Back.png"), "袋獸", moves);
    ...
    DEX["墨海馬"] = new PokemonType(basicStat, 116, new Image(pokemonImagePath + "116_墨海馬.png"), new Image(pokemonImagePath + "116_墨海馬_Back.png"), "墨海馬", moves);
    ...
    DEX["海刺龍"] = new PokemonType(basicStat, 117, new Image(pokemonImagePath + "117_海刺龍.png"), new Image(pokemonImagePath + "117_海刺龍_Back.png"), "海刺龍", moves);
    ...
    DEX["角金魚"] = new PokemonType(basicStat, 118, new Image(pokemonImagePath + "118_角金魚.png"), new Image(pokemonImagePath + "118_角金魚_Back.png"), "角金魚", moves);
    ...
    DEX["金魚王"] = new PokemonType(basicStat, 119, new Image(pokemonImagePath + "119_金魚王.png"), new Image(pokemonImagePath + "119_金魚王_Back.png"), "金魚王", moves);
    ...
    DEX["海星星"] = new PokemonType(basicStat, 120, new Image(pokemonImagePath + "120_海星星.png"), new Image(pokemonImagePath + "120_海星星_Back.png"), "海星星", moves);
    ...
    DEX["寶石海星"] = new PokemonType(basicStat, 121, new Image(pokemonImagePath + "121_寶石海星.png"), new Image(pokemonImagePath + "121_寶石海星_Back.png"), "寶石海星", moves);
    ...
    DEX["魔牆人偶"] = new PokemonType(basicStat, 122, new Image(pokemonImagePath + "122_魔牆人偶.png"), new Image(pokemonImagePath + "122_魔牆人偶_Back.png"), "魔牆人偶", moves);
    ...
    DEX["飛天螳螂"] = new PokemonType(basicStat, 123, new Image(pokemonImagePath + "123_飛天螳螂.png"), new Image(pokemonImagePath + "123_飛天螳螂_Back.png"), "飛天螳螂", moves);
    ...
    DEX["迷唇姐"] = new PokemonType(basicStat, 124, new Image(pokemonImagePath + "124_迷唇姐.png"), new Image(pokemonImagePath + "124_迷唇姐_Back.png"), "迷唇姐", moves);
    ...
    DEX["電擊獸"] = new PokemonType(basicStat, 125, new Image(pokemonImagePath + "125_電擊獸.png"), new Image(pokemonImagePath + "125_電擊獸_Back.png"), "電擊獸", moves);
    ...
    DEX["鴨嘴火獸"] = new PokemonType(basicStat, 126, new Image(pokemonImagePath + "126_鴨嘴火獸.png"), new Image(pokemonImagePath + "126_鴨嘴火獸_Back.png"), "鴨嘴火獸", moves);
    ...
    DEX["凱羅斯"] = new PokemonType(basicStat, 127, new Image(pokemonImagePath + "127_凱羅斯.png"), new Image(pokemonImagePath + "127_凱羅斯_Back.png"), "凱羅斯", moves);
    ...
    DEX["肯泰羅"] = new PokemonType(basicStat, 128, new Image(pokemonImagePath + "128_肯泰羅.png"), new Image(pokemonImagePath + "128_肯泰羅_Back.png"), "肯泰羅", moves);
    ...
    DEX["鯉魚王"] = new PokemonType(basicStat, 129, new Image(pokemonImagePath + "129_鯉魚王.png"), new Image(pokemonImagePath + "129_鯉魚王_Back.png"), "鯉魚王", moves);
    ...
    DEX["暴鯉龍"] = new PokemonType(basicStat, 130, new Image(pokemonImagePath + "130_暴鯉龍.png"), new Image(pokemonImagePath + "130_暴鯉龍_Back.png"), "暴鯉龍", moves);
    ...
    DEX["拉普拉斯"] = new PokemonType(basicStat, 131, new Image(pokemonImagePath + "131_拉普拉斯.png"), new Image(pokemonImagePath + "131_拉普拉斯_Back.png"), "拉普拉斯", moves);

    basicStat = {maxHP: 48, attack: 48, defense: 48, special: 48, speed: 48};
    moves = [new GradingMove(undefined, MoveDEX["變身"])];
    DEX["百變怪"] = new PokemonType(basicStat, 132, new Image(pokemonImagePath + "132_百變怪.png"), new Image(pokemonImagePath + "132_百變怪_Back.png"), "百變怪", moves);
    ...
    DEX["伊布"] = new PokemonType(basicStat, 133, new Image(pokemonImagePath + "133_伊布.png"), new Image(pokemonImagePath + "133_伊布_Back.png"), "伊布", moves);
    ...
    DEX["水伊布"] = new PokemonType(basicStat, 134, new Image(pokemonImagePath + "134_水伊布.png"), new Image(pokemonImagePath + "134_水伊布_Back.png"), "水伊布", moves);
    ...
    DEX["雷伊布"] = new PokemonType(basicStat, 135, new Image(pokemonImagePath + "135_雷伊布.png"), new Image(pokemonImagePath + "135_雷伊布_Back.png"), "雷伊布", moves);
    ...
    DEX["火伊布"] = new PokemonType(basicStat, 136, new Image(pokemonImagePath + "136_火伊布.png"), new Image(pokemonImagePath + "136_火伊布_Back.png"), "火伊布", moves);
    ...
    DEX["多邊獸"] = new PokemonType(basicStat, 137, new Image(pokemonImagePath + "137_多邊獸.png"), new Image(pokemonImagePath + "137_多邊獸_Back.png"), "多邊獸", moves);
    ...
    DEX["菊石獸"] = new PokemonType(basicStat, 138, new Image(pokemonImagePath + "138_菊石獸.png"), new Image(pokemonImagePath + "138_菊石獸_Back.png"), "菊石獸", moves);
    ...
    DEX["多刺菊石獸"] = new PokemonType(basicStat, 139, new Image(pokemonImagePath + "139_多刺菊石獸.png"), new Image(pokemonImagePath + "139_多刺菊石獸_Back.png"), "多刺菊石獸", moves);
    ...
    DEX["化石盔"] = new PokemonType(basicStat, 140, new Image(pokemonImagePath + "140_化石盔.png"), new Image(pokemonImagePath + "140_化石盔_Back.png"), "化石盔", moves);
    ...
    DEX["鐮刀盔"] = new PokemonType(basicStat, 141, new Image(pokemonImagePath + "141_鐮刀盔.png"), new Image(pokemonImagePath + "141_鐮刀盔_Back.png"), "鐮刀盔", moves);
    ...
    DEX["化石翼龍"] = new PokemonType(basicStat, 142, new Image(pokemonImagePath + "142_化石翼龍.png"), new Image(pokemonImagePath + "142_化石翼龍_Back.png"), "化石翼龍", moves);
    ...
    DEX["卡比獸"] = new PokemonType(basicStat, 143, new Image(pokemonImagePath + "143_卡比獸.png"), new Image(pokemonImagePath + "143_卡比獸_Back.png"), "卡比獸", moves);
    ...
    DEX["急凍鳥"] = new PokemonType(basicStat, 144, new Image(pokemonImagePath + "144_急凍鳥.png"), new Image(pokemonImagePath + "144_急凍鳥_Back.png"), "急凍鳥", moves);
    ...
    DEX["閃電鳥"] = new PokemonType(basicStat, 145, new Image(pokemonImagePath + "145_閃電鳥.png"), new Image(pokemonImagePath + "145_閃電鳥_Back.png"), "閃電鳥", moves);
    ...
    DEX["火焰鳥"] = new PokemonType(basicStat, 146, new Image(pokemonImagePath + "146_火焰鳥.png"), new Image(pokemonImagePath + "146_火焰鳥_Back.png"), "火焰鳥", moves);
    ...
    DEX["迷你龍"] = new PokemonType(basicStat, 147, new Image(pokemonImagePath + "147_迷你龍.png"), new Image(pokemonImagePath + "147_迷你龍_Back.png"), "迷你龍", moves);
    ...
    DEX["哈克龍"] = new PokemonType(basicStat, 148, new Image(pokemonImagePath + "148_哈克龍.png"), new Image(pokemonImagePath + "148_哈克龍_Back.png"), "哈克龍", moves);
    ...
    DEX["快龍"] = new PokemonType(basicStat, 149, new Image(pokemonImagePath + "149_快龍.png"), new Image(pokemonImagePath + "149_快龍_Back.png"), "快龍", moves);
    ...
    DEX["超夢"] = new PokemonType(basicStat, 150, new Image(pokemonImagePath + "150_超夢.png"), new Image(pokemonImagePath + "150_超夢_Back.png"), "超夢", moves);
    ...
    DEX["夢幻"] = new PokemonType(basicStat, 151, new Image(pokemonImagePath + "151_夢幻.png"), new Image(pokemonImagePath + "151_夢幻_Back.png"), "夢幻", moves);
