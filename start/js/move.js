...
(() => {
    ...
    DEX["吼叫"] = new Move("吼叫", "趕走對手，強制讓後備寶可夢上場。對手為野生寶可夢時，戰鬥將直接結束。", Types.Normal, MoveTypes.Status, undefined, 100, -6);
    ...
    DEX["吹飛"] = new Move("吹飛", "吹飛對手，強制讓後備寶可夢上場。對手為野生寶可夢時，戰鬥將直接結束。", Types.Normal, MoveTypes.Status, undefined, 100, -6);
